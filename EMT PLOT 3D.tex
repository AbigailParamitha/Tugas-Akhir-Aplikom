...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-001.png}
...
>plot3d("x^2+y^2"):
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-002.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-003.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-004.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-005.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-007.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-008.png}
\begin{eulerprompt}
>function f(r) := exp(-r/2)*cos(r); ...
>plot3d("f(x^2+y^2)",>polar,scale=[1,1,0.4],r=2pi,frame=3,zoom=4):
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-009.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-010.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-011.png}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-012.png}
\begin{eulerprompt}
>plot3d("exp(x*y)",angle=100°,>contour,color=green):
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-013.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-014.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-015.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-016.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-018.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-019.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-020.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-021.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-022.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-023.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-024.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-025.png}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-028.png}
\begin{eulerprompt}
>plot3d("x^2+y^2+4*x*z+z^3",>implicit,r=2,zoom=2.5):
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-029.png}
...
>scale=1.4,height=50°):
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-031.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-032.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-034.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-038.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-039.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-040.png}
\begin{eulerprompt}
>t=linspace(0,4pi,1000); plot3d(cos(t),sin(t),t/2pi,>wire, ...
>linewidth=3,wirecolor=blue):
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-041.png}
\begin{eulerprompt}
>X=cumsum(normal(3,100)); ...
> plot3d(X[1],X[2],X[3],>anaglyph,>wire):
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-042.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-043.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-044.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-045.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-046.png}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-047.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-048.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-049.png}
\begin{eulerprompt}
>Z=intrandom(5,100,6); v=zeros(5,6); ...
>loop 1 to 5; v[#]=getmultiplicities(1:6,Z[#]); end; ...
>columnsplot3d(v',scols=1:5,ccols=[1:5]):
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-050.png}
...
>level=[-2;0],n=100):
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-051.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-056.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-057.png}
...
\end{eulerprompt}
\eulerimg{12}{images/EMT PLOT 3D-058.png}
\begin{eulercomment}
...
>myplot(x,y,z):
\end{eulerprompt}
\eulerimg{25}{images/EMT PLOT 3D-059.png}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT PLOT 3D-060.png}
...
\end{eulerprompt}
\eulerimg{26}{images/EMT PLOT 3D-061.png}
\eulerimg{25}{images/EMT PLOT 3D-062.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{26}{images/EMT PLOT 3D-063.png}
\begin{eulercomment}
...
>  <fscale,zoom=3.8);
\end{eulerprompt}
\eulerimg{26}{images/EMT PLOT 3D-064.png}
...
\end{eulerprompt}
\eulerimg{26}{images/EMT PLOT 3D-065.png}
\begin{eulercomment}
...
>  w=500,h=300);
\end{eulerprompt}
\eulerimg{15}{images/EMT PLOT 3D-066.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{26}{images/EMT PLOT 3D-067.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{20}{images/EMT PLOT 3D-068.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{26}{images/EMT PLOT 3D-069.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{26}{images/EMT PLOT 3D-070.png}
...
>povend;
\end{eulerprompt}
\eulerimg{26}{images/EMT PLOT 3D-071.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{26}{images/EMT PLOT 3D-072.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{26}{images/EMT PLOT 3D-073.png}
...
>povend();
\end{eulerprompt}
\eulerimg{26}{images/EMT PLOT 3D-074.png}
...
>povend();
\end{eulerprompt}
\eulerimg{26}{images/EMT PLOT 3D-075.png}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT PLOT 3D-076.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT PLOT 3D-077.png}
...
>povend(h=320,w=480);
\end{eulerprompt}
\eulerimg{17}{images/EMT PLOT 3D-078.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT PLOT 3D-081.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{26}{images/EMT PLOT 3D-082.png}
