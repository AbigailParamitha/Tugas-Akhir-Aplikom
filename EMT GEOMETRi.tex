...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-001.png}
\begin{eulercomment}
Hitung luas ABC:
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-003.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-004.png}
...
\begin{eulercomment}
\eulerheading{JAWAB : ** Nomor 1}
\begin{eulercomment}
Titik singgung BC dengan lingkaran dalam
\end{eulercomment}
\begin{eulerprompt}
>s=lineThrough(B,C)
\end{eulerprompt}
...
>plotSegment(L,Q,"c"):
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-005.png}
...
>color(3); plotLine(k):
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-006.png}
\begin{eulerprompt}
>plotSegment(P,L,"r"):
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-007.png}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-019.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-021.png}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-022.png}
\begin{eulercomment}
...
\begin{euleroutput}
  ...
  Error in ^
  Error in expression: 3*sqrt(-c^4+2*b^2*c^2+2*a^2*c^2-b^4+2*a^2*b^2-a^4)/(4*a)
   %ploteval:
      y0=f$(x[1],args());
  adaptiveevalone:
      s=%ploteval(g$,t;args());
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-033.png}
\begin{eulercomment}
...
\begin{eulerformula}
\[
\left[ 2\,H\left(a , b , d-b-a\right)\,\left(\frac{d}{d\,a}\,H
 \left(a , b , d-b-a\right)\right)=0 , 2\,H\left(a , b , d-b-a\right)
 \,\left(\frac{d}{d\,b}\,H\left(a , b , d-b-a\right)\right)=0
  \right] 
\]
\end{eulerformula}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-042.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-049.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-052.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-054.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-059.png}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-061.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-063.png}
\begin{eulerprompt}
...
>insimg(30);
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-070.png}
\begin{eulercomment}
Tentu saja,
...
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-083.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-109.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-114.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-119.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-123.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-124.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-125.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-126.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-127.png}
\begin{eulercomment}
\end{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-128.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-4,xmax=1,ymin=-2,ymax=2,hue=1,title="The minimum is on A");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-129.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-130.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-2,xmax=2,ymin=-2,ymax=2,hue=1,title="The Fermat point");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-131.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-132.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],points=1,add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-133.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-134.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],add=1,color=12,points=1);
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-135.png}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-136.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-140.png}
...
>povend();
\end{eulerprompt}
\eulerimg{26}{images/EMT GEOMETRi-141.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-142.png}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-143.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-144.png}
...
>plotSegment(A,B,""):
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-145.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-148.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-149.png}
\eulersubheading{Nomor 3}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-150.png}
\begin{eulercomment}
no.4
\end{eulercomment}
\begin{eulerprompt}
...
>fcontour("d2",xmin=-2,xmax=2,ymin=-3,ymax=1,hue=1):
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-151.png}
\begin{eulercomment}
...
>plot3d("d2",xmin=-2,xmax=2,ymin=-3,ymax=1):
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-152.png}
\begin{eulercomment}
Batasan ke garis PQ
\end{eulercomment}
\begin{eulerprompt}
>plot2d("abs(x+1)+abs(x-1)",xmin=-3,xmax=3): 
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-153.png}
...
>fcontour("d2",xmin=-2,xmax=2,ymin=-3,ymax=1,hue=1): 
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-154.png}
\begin{eulercomment}
Grafik yang lebih menarik
\end{eulercomment}
\begin{eulerprompt}
>plot3d("d2",xmin=-2,xmax=2,ymin=-3,ymax=1):
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-155.png}
\begin{eulerprompt}
>plot2d("abs(x+1)+abs(x-1)",xmin=-3,xmax=3): 
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRi-156.png}
\end{eulernotebook}
\end{document}
