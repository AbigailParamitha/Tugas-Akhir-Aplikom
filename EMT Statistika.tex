...
\end{euleroutput}
\begin{eulercomment}
Kita dapat memplot plot kotak untuk data. Dalam kasus kami tidak ada
outlier.
\end{eulercomment}
\begin{eulerprompt}
>aspect(1.75); boxplot(M):
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-001.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-003.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-005.png}
\eulerheading{Tabel}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-007.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-008.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-011.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-012.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-013.png}
\begin{eulerformula}
\[
\text{normaldis(x,m,d)}=\int_{-\infty}^x \frac{1}{d\sqrt{2\pi}}e^{-\frac{1}{2 }(\frac{tm}{d})^2}\ dt.
\]
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-016.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-017.png}
\begin{eulercomment}
...
adalah tahun pemilihan.f the election.
\end{eulercomment}
\begin{eulerprompt}
...
>statplot(YT,BT1,"b"):
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-019.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-020.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-021.png}
\begin{eulercomment}
...
>  angle=30°,ccols=CP):
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-022.png}
\begin{eulercomment}
...
>shrinkwindow():
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-023.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-024.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-025.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-026.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-027.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-028.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-029.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-030.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-031.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-032.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-033.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-034.png}
...
>figure(0):
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-037.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-038.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-039.png}
\eulerheading{Tes}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-040.png}
\begin{eulerprompt}
>t=count(R,21);
\end{eulerprompt}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{eulercomment}
Selanjutnya kita hitung jarak antara dua bilangan yang kurang dari
0,05.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-041.png}
\begin{eulercomment}
Hapus datanya.
\end{eulercomment}
\begin{eulerprompt}
...
>statplot(u,f,"h"):
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-042.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-043.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-044.png}
\eulerheading{Daftar}
\begin{eulercomment}
...
membuat file di direktori kerja saat ini.working directory.
\end{eulercomment}
\begin{eulerprompt}
>file="test.csv";  ...
...
\end{eulerprompt}
\eulerimg{14}{images/EMT Statistika-045.png}
\begin{eulercomment}
